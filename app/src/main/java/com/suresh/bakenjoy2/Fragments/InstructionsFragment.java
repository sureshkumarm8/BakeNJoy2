...
import com.suresh.bakenjoy2.adaptor.StepRecyclerAdapter;
...
//        }
    ...
    public void setIngredientsView(View rootView){
                ...
                if(mRecipe != null){
                    ...
                    if(fragmentManager != null) {
                        fragmentManager.beginTransaction()
                                .replace(R.id.details_frame_layout, ingredientsFragment)
